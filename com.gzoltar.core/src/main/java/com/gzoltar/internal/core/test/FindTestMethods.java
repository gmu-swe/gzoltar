 ...
 */
package com.gzoltar.internal.core.test;
...
import com.gzoltar.internal.core.instr.matchers.TestNGMatcher;
import com.gzoltar.internal.core.test.junit.FindJUnitTestMethods;
import com.gzoltar.internal.core.test.testng.FindTestNGTestMethods;
...
public abstract class FindTestMethods {
  ...
  private static List<TestMethod> findTestMethodsInClass(final WildcardMatcher testsMatcher,
    ...
    switch (classType) {
      case JUNIT:
        return FindJUnitTestMethods.find(testsMatcher, ctClass.name.replace('/','.'));
      case TESTNG:
        return FindTestNGTestMethods.find(testsMatcher, ctClass.name.replace('/','.'));
      default:
        return new ArrayList<TestMethod>(0);
    }
  }
